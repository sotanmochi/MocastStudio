...
{
    public sealed class MotionCaptureUIViewLifetimeScope : LifetimeScope
    {
        ...
        {
            Debug.Log($"[{nameof(MotionCaptureUIViewLifetimeScope)}] Configure");

            builder.RegisterEntryPoint<MotionCaptureUIViewLifecycle>();
